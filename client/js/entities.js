...
export class GameEngine {
    ...
    startDemo() {
        ...
        // Hide the entire UI canvas completely
    ...
    start(playerClass) {
        ...
        if (lb) {
            ...
            lb.style.display = (window.gameSettings && window.gameSettings.showLeaderboard === false) ? 'none' : 'block';
        }
        
        const badgeUI = document.getElementById('upgrade-badges');
        if (badgeUI) {
            badgeUI.classList.remove('hidden');
            badgeUI.style.display = (window.gameSettings && window.gameSettings.showBadges === false) ? 'none' : 'flex';
            badgeUI.innerHTML = '';
        }
